    ...
    public function index_get() {
		...
		$taiza="";
            if ($id)  {
                ...
                $data['type_effort_peche'] = $site_embarquement->type_effort_peche;
                /*
                ...
                if ($menu) {
                    foreach ($menu as $key => $value) {
                        ...
                        $data[$key]['type_effort_peche'] = $value->type_effort_peche;
        ...
        if ($supprimer == 0)
        {
            if ($id == 0)
            {
                $data = array(
                    ...
                    'type_effort_peche' => $this->post('type_effort_peche')
                );
                if (!$data)
                {
                    $this->response([
