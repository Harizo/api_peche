...
class Sip_reporting_peche_artisanale extends REST_Controller
{
    ...
    public function index_get() {	
		...
		if($menu =="menu_1_1") {
			...
			$titre_etat="Quantité par espèce peche artisanale";
			...
			$titre_etat="Quantité par navire espèce peche artisanale";
			...
			$titre_etat="Quantité par espèce par mois peche artisanale";
			...
			$titre_etat="Quantité par navire espèce marrée peche artisanale";
			...
			$titre_etat="Quantité par espèce société peche artisanale";
			...
			$titre_etat="Quantité par navire mensuel peche artisanale";
		}
        //EXPORT EXCEL
            if ($export_excel == 'oui') 
            {
                ...
                $objPHPExcel->getProperties()->setCreator("S.I.P")
                            ...
                            ->setTitle("reporting peche artisanale")
                            ->setSubject("reporting peche artisanale")
                            ->setDescription("reporting peche artisanale")
                            ->setKeywords("reporting peche artisanale")
                            ->setCategory("reporting peche artisanale");
