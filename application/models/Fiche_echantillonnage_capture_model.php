   ...
   /*public function essai($requete,$reqsansSiteEspece,$reqcadre,$annee)
    {
       $this->db->select("DATE_FORMAT(fiche_echantillonnage_capture.date,'%Y') as anee,DATE_FORMAT(fiche_echantillonnage_capture.date,'%c') as mois,enquete_cadre.id_region as id_reg,region.nom as nom_region,fiche_echantillonnage_capture.id_district as id_distr,enquete_cadre.id_site_embarquement as id_site,enquete_cadre.id_unite_peche as id_unite,unite_peche.libelle as libelle,date");
        ...
        $result =  $this->db->from('enquete_cadre,echantillon,fiche_echantillonnage_capture ,espece_capture,unite_peche,region,district')
                    ...
                    ->where('fiche_echantillonnage_capture.id_district = district.id')
                    ->where($reqcadre)
                    //->order_by('DATE_FORMAT(fiche_echantillonnage_capture.date,"%c") = mois')
                    ->group_by('anee,mois,id_reg,id_distr,id_site,id_unite')
                    //->group_by('anee')
